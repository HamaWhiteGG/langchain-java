...
- [OpenAI](langchain-examples/src/main/java/com/hw/langchain/examples/llms/OpenAIExample.java), 
  - support [stream](langchain-examples/src/main/java/com/hw/langchain/examples/llms/StreamOpenAIExample.java)
  - support [functions](openai-client/src/test/java/com/hw/openai/function/ChatFunctionTest.java)
