...
public class ChatMessagePromptTemplate extends BaseStringMessagePromptTemplate {
    ...
    public static ChatMessagePromptTemplate fromTemplate(String template) {
        return BaseStringMessagePromptTemplate.fromTemplate(ChatMessagePromptTemplate.class, template);
    }
