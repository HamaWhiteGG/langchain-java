...
public class BaseUtils {
    ...
    private static BasePromptTemplate getPrompt(String documentContents, List<AttributeInfo> attributeInfo,
        ...
        StructuredQueryOutputParser outputParser = StructuredQueryOutputParser.fromComponents(allowedComparators, allowedOperators);
        return new FewShotPromptTemplate(examples, EXAMPLE_PROMPT, prefix, suffix, ListUtil.of("query"), outputParser);
    }
