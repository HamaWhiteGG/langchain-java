...
class SummarizeUtilsTest {
    ...
    void testLoadStuffChain() {
        ...
        var expected =
                "The article discusses the concept of building autonomous agents powered by large language models (LLMs). "
                        +
                        "It explores the components of such agents, including planning, memory, and tool use. " +
                        "The article provides case studies and proof-of-concept examples of LLM-powered agents, " +
